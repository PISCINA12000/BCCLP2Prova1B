...
export default function Candidato(props) {
    ...
    function detalharCandidato(evento){
        evento.preventDefault()
        return(
            <DetalhesCandidato id={props.key} candidato={props.candidato}/>
        )
    }
    ...
    return (
        <Card style={{ width: '18rem' }}>
            ...
            <Card.Body>
                ...
                <Button className="mt-1" variant="success" onClick={detalharCandidato((evento)=>{detalharCandidato()})}>Conheça minhas propostas</Button>
            </Card.Body>
        </Card>
    );
}